...
M=[params.m1*params.l2^2+params.m2*params.l1^2+params.I -sin(theta1-theta2)*params.m1*params.l2*params.l3 -(params.m1+params.m2)*params.l2*sin(theta1) 0 0
    -sin(theta1-theta2)*params.m1*params.l2*params.l3 params.m1*params.l3^2 params.m1*params.l3*cos(theta2) 0 0
    -(params.m1*params.l2+params.m2*params.l1)*sin(theta1) params.m1*params.l3*cos(theta2) params.m1+params.m2+params.m3 0 0
    0 0 0 params.m4 0
    0 0 0 0 params.m4]
	...
	f=[-cos(theta1-theta2)*params.m1*params.l2*params.l3*dtheta2^2-params.m1*params.g*params.l2*cos(theta1)-params.m2*params.g*params.l1*cos(theta1)
	    ...
	    (params.m1*params.l2+params.m2*params.l1)*cos(theta1)*dtheta1^2+params.m1*params.l3*sin(theta2)*dtheta2^2
	    0
	    -params.m4*params.g]
